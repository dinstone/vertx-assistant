...
public final class MediaType {
    ...
    /**
     * Returns the high-level media type, such as "text", "image", "audio", "video",
     * or "application".
     */
    public String type() {
        return type;
    ...
    /**
     * Returns a specific media subtype, such as "plain" or "png", "mpeg", "mp4" or
     * "xml".
     */
    ...
    /**
     * Returns the charset of this media type, or {@code defaultValue} if this media
     * type doesn't specify a charset.
     */
    public Charset charset(Charset defaultValue) {
        return charset != null ? Charset.forName(charset) : defaultValue;
    }

    public String charset(String defaultValue) {
        return charset != null ? charset : defaultValue;
    }

    /**
     * Returns the encoded media type, like "text/plain; charset=utf-8", appropriate
