...
import com.dinstone.vertx.rs.model.ArgType;
...
public class AnnotationRouteResolver extends AbstractRouteResolver implements RouteResolver {
    ...
    protected List<RouteDefinition> parseRouteDefinitions(Object service) {
        ...
        for (final Method method : clazz.getMethods()) {
            try {
                ...
                RouteDefinition definition = parseRouteDefinition(rsa, produces, consumes, method);
                if (definition != null) {
    ...
    private RouteDefinition parseRouteDefinition(RestService rs, Produces produces, Consumes consumes, Method method)
            throws Throwable {
