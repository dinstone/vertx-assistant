...
public class MethodParameter {
    ...
    /**
     * Index of argument in regex if not given as @PathParam()
     */
    ...
    public MethodParameter(ParameterType parameterType, String paramName) {
        ...
        type = parameterType;
        name = paramName != null ? paramName.trim() : paramName;
    }
    ...
    public void join(MethodParameter joining) {
        ...
        if (ParameterType.unknown.equals(type) && !ParameterType.unknown.equals(joining.type)) {
    ...
    public boolean sameAs(MethodParameter additionalParam) {
        ...
        return (index >= 0 && additionalParam.index == index || StringUtils.equals(name, additionalParam.name));
    }
